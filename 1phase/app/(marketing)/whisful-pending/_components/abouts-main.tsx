    ...
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="flex justify-center space-x-4 mb-4">
        ...
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/whisful-today">
            <a>Today Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/whisful-total">
            <a>Total Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/whisful-pending">
            <a>Pending Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/whisful-3day">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSBCYW6n0XaY1khrZ_SVRyskmpuWb-13-gnYGyrcPzJu_zUhBPosHXICkG_K8w0jcnH-eHekqSxt4Oq/pubhtml?gid=2108884659&single=true"
          width="300%"
