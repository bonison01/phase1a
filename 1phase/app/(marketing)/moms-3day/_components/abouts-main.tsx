  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRA6sxVE4Jt6JvVG7KedhOsdXvoK7-acKFIn9GtFDjeGp3yPSHNfjFFNJm25UwKWK-zxFlEK3vRsmwu/pubhtml?gid=1154534531&single=true"
          width="300%"
