  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRvREY2T47K850u5QJj6t4yLXi8WUNiQrofjXzICrGdogf8QQ_LFLZE1L7OS2SGjP0PkTKRv-bf5okM/pubhtml?gid=1385903661&single=true"
          width="300%"
