  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQQ91j93_78D79SEelzb-aDpre_kIZLpj6hSzisZ7Eaklzpxw4k1pYp60yRcGTgDLhqb74AO3G7JX5I/pubhtml?gid=691031807&single=true"
          width="300%"
