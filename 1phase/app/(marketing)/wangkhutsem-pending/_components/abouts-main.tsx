  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQtKWCpp_QSbE6IimD6tTBBF7ZcMTPsmdszC8ivnKYBuNRLgpSS12oSDuXCRniL8kU0069Bx70cAgQA/pubhtml?gid=2108884659&single=true"
          width="300%"
