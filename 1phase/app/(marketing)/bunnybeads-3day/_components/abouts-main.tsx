  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTPNPhOD2yuXywuxjfZNH07zFVdWR-xMJFlbY7BzW1psNeLM7HnQoo7J0A3njgnIS7FUlDTdt83MHYW/pubhtml?gid=822319740&single=true"
          width="300%"
