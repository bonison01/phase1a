  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT39M982_685nQWQQgCoyybWi5uHDXRSKOPHDBF8jkrpK75fygbtydoj3pLQ_8Q_y9JDLG1HzS-el8N/pubhtml?gid=691031807&single=true"
          width="300%"
