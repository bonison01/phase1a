  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSEf7nYSiRhg-pOiIBBUPMpvpUg-BxwEGOFHIvKcpAl-bUxDThi7Zw0fmwwUYbVJQakJq85YzSGqb6V/pubhtml?gid=2108884659&single=true"
          width="300%"
