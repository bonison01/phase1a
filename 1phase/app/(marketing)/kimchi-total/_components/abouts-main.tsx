  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQyTMgPP7SgrbDlNkr1mZA9ZQkrqUSGEJK1M1VwK5NyFnKEcPpwfnwC3ZpZVZ4YvmSpTECQUPBCGXRs/pubhtml?gid=691031807&single=true"
          width="300%"
