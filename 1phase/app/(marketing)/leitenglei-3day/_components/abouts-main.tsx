  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRskH_fi48wTamB553E1Ed-CLkq8AcfLijSVl3igEZQUr7OtxOlZbmyhAZMrWPCmMDe9E_4tmQYvpAn/pubhtml?gid=943112273&single=true"
          width="300%"
