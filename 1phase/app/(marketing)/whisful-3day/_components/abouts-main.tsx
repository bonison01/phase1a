  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ1l3nylwr-PBSUJZmnUzilHMeTEtz1jYTtJFM5g9Z0B-O0sqLffok9g40pb953ffzPVqVEfJr1C3oZ/pubhtml?gid=486050008&single=true"
          width="300%"
