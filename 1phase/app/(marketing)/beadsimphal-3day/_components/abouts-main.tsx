  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ5wT92fsa3UsxCMz4ewWORU_3QXHb7cpqAEFt7jlF-zKnBPLOYcSKTZkRuiNNKwGGIcdiW-V_eDd9i/pubhtml?gid=389081528&single=true"
          width="300%"
