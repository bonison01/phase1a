  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTjBHgqxRRMDpa6Dc_AZ4rnUUhkAmKUp50Y69wd6ZeEUQPOzOmhHRK1_hqG9aPAT8FpDEX9WubdgkHD/pubhtml?gid=2108884659&single=true"
          width="300%"
