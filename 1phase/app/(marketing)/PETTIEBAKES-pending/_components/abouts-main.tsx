  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vToHHHS6MFl7QEMfkDEpCmCjGDWeaKAjI64s35P7xCb3S8psHMnKAs08QtaS23DX5wnwZLsiYxjNhkm/pubhtml?gid=2108884659&single=true"
          width="300%"
