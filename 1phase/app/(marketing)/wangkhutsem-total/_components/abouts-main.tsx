  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTAqsmhCGec_VZiShPCrrg9dBYsjy5ktQL1NWd6QV2OALy3UgXYeTKJcBuUSTK4bjNkIqDw-VfgA-zA/pubhtml?gid=691031807&single=true"
          width="300%"
