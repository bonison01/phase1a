  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRALWLlL2LRP4jjBox9nJbs3QpaNanWJQT1GNIOrJGY2AAwQk2A3Cm7EeZXj7BzkLnzaW_bxts9KXGK/pubhtml?gid=2108884659&single=true"
          width="300%"
