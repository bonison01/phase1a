  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRvB8JcdqSG01aq1Znv1h3ncxJpskGMBS9Pri3nUwjXpT7RL0dcYM6KQl_0AWmeYt6CxplyVI_L-Qyq/pubhtml?gid=691031807&single=true"
          width="300%"
