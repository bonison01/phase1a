  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQVpC7Id1XkY4_4ko32wMjb9y90ibIrLCUDmo0l5tCWB3CrkNpl-dqIm8h6f42amLYVp_4x6beS8Vd2/pubhtml?gid=691031807&single=true"
          width="300%"
