    ...
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="flex justify-center space-x-4 mb-4">
        ...
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/plantaddiction-today">
            <a>Today Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/plantaddiction-total">
            <a>Total Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/plantaddiction-pending">
            <a>Pending Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/plantaddiction-3day">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQzLtPWik6rhh_f_iRT33IHaXe3ReH_gT2kuJomA8Uw0M_cId_5vtYButQyUsR8jR06PCVqykiY0zNp/pubhtml?gid=2025558791&single=true"
          width="300%"
