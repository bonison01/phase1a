  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ-LaeSB7sPO_fP3lrHLe0LoUidwpvu_kxoTj9JEES_mtxx59BS_l-m5XpmSK90f-EHwjZl6kn6Ik_q/pubhtml?gid=2108884659&single=true"
          width="300%"
