  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT3u0mD-x9yZiXDJUP7xR-bG4f1sOBdgmet9PkJiRAnpxIE639U_lNa1hap_GID51l5U8yNT1oeuYWE/pubhtml?gid=1967807820&single=true"
          width="300%"
