  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vR3ZcmL1yxtiMAnZjIXZEGJOR2XotMJL5AvRvGap_1DS7eXEY4wVN4besMfTgfVLiiDTcIKf4iGrvsz/pubhtml?gid=486050008&single=true"
          width="300%"
