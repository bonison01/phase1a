  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vR2J6r8WPA_u-tSGxCH1OfIJmgrL84YGqIkMuNNFcpgsrg5TwFohXF4MMoWXDeDsda5flTj_C7gEFFR/pubhtml?gid=2108884659&single=true"
          width="300%"
