  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQGb-JAdIDJuFsw7bSrRXr0tkHPYv1keFEJPLnWpNzYf7dCxWCWF6HaEFX0FyhvPgbGvdbQR6mYkPAx/pubhtml?gid=1176418693&single=true"
          width="300%"
