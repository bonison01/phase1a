  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSQzxepyhL0FT_MctrD-7EluhCe693ntJiQ2qA7vBHM0V12wwKj0CWYyLeI5UkWRUxCQ9hc5p8k0CrJ/pubhtml?gid=691031807&single=true"
          width="300%"
