  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSdGJ5o4NNx3fpn3LMtmaUGmiI8f8tu92GYjAGdswFtDidvok3ln4gLK04X3wVgEZMSYIu8057LCnhN/pubhtml?gid=691031807&single=true"
          width="300%"
