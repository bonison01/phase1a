  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRrsD80Bp_BpM_U2cDhFurdhYPY3d0OZ4iXqNYZy4u3cFrSJpzKhCLYSgvEpGhwOuPpaNG-7WPCpDFK/pubhtml?gid=1023013620&single=true"
          width="300%"
