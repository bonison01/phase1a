  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQuMMwrdUUiusDUvMc3B7HxX5MfTEazOy5J6FPaImFfv6r22gm8cUCCPdDsCnNCtrLx8q_5fGrsbDRy/pubhtml?gid=691031807&single=true"
          width="300%"
