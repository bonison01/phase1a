  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQDG208BKyCRZPkoevsfXfKGFDzF2CsGOvy5otEBXvI0ma6pgBHz17K7P6S9hdUk1jCFEQ46vKDHKaa/pubhtml?gid=691031807&single=true"
          width="300%"
