  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS0xEi6d-Hos1MucoHQxjzcjEXWtMThlYNzKXiXu3M9weNurm0v-_oSuNhcjDe6W1jDr-J5f1dyv4XO/pubhtml?gid=1385903661&single=true"
          width="300%"
