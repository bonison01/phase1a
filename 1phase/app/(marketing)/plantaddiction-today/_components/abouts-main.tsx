  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSwObGkmSzG1ETeC8qTGJRJSCO1qcTH0ayT2HYNoPJuRWb2rjnQcsGpJHk6Q5KK2k-H13hV4njJnc7R/pubhtml?gid=1385903661&single=true"
          width="300%"
