  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRU0-m3f6U0to27cL-ncSHn6RW6vVysIP0UFXPS69Ovhf0oSSsMHZIObjpDWk7oDCIhoLURkDdS5pxW/pubhtml?gid=1385903661&single=true"
          width="300%"
