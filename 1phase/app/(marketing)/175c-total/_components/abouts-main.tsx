  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ4lGvSRnYQUInoFIyzTRnl5uT-0H3bumKa7mAPL-Tkx9wErmZiXrhywV5zERfS2wryuhrhMmdhg_9w/pubhtml?gid=691031807&single=true"
          width="300%"
