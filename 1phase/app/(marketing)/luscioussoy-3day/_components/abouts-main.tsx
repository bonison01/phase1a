  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSZTuVl9klPWcwwmddgMzfMdDefauqibIyJuBOvaPqtw-6OhbA1NWgaJATzYJcwvq33ZmVtYPQ7Awx1/pubhtml?gid=448187584&single=true"
          width="300%"
