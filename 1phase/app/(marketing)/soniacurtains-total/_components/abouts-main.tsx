  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT14-vbW6ojoOSegQoFRNNmMo_ya2xPhHzUQ0F4DleVeZjcXm4l_ITlpRJm3BwExTX5QkPsg30QFapZ/pubhtml?gid=691031807&single=true"
          width="300%"
