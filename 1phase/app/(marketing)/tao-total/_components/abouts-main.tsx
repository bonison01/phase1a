  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRmWlv7jz9VLXsolg_aKeHNqUm4wWKV7NgBrX8-fdTkhBpLGtF6ZO_4QvPFHKAWXTMZb0FEd9pj5kED/pubhtml?gid=691031807&single=true"
          width="300%"
