  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS60KMS1Dop_4nqlawJ4F0J8OL5sJgPluzWKkTF-axtWUhjbAGOUci8GNWyYl0mmcitC57D96qbyIUE/pubhtml?gid=1798922779&single=true"
          width="300%"
