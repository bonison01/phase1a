  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vS21k8u4S1lKsdcN46LyPVWY4PWA9RD3eOjgJV_fLKZuxev2EkgkqHYOt6MNuoMUZN9m3ohCHXriBQE/pubhtml?gid=1385903661&single=true"
          width="300%"
