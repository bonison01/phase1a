  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSrw1GfV-giOB4JX4TzOuInf5Jzj1EtTRd_C4FdMTgpBQEFniWK1Aqt59qhAnl4YHjOz0et2bfjO1uC/pubhtml?gid=650317713&single=true"
          width="300%"
