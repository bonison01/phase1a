  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQq_aqK-amenqRkSmPeC1mGRPMpQ_rEla0a-31N1sO6fLk9E0XEk3Tua2isHur-k5IK0mhIq6l5m7Y_/pubhtml?gid=2108884659&single=true"
          width="300%"
