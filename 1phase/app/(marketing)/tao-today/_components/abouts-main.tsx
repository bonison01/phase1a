  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQ46pj7_HSvZgAON_k5BRypfaCRn7D2OiXIFoMG89G9jLlj6OqqXC8olsE62aqtKAIK_O4QSD6XUX3T/pubhtml?gid=1385903661&single=true"
          width="300%"
