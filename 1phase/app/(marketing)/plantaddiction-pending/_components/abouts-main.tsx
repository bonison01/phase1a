  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTs1Ser8LaaKYeiptbZxLM9YipBkKBSCPZQq4sWYvl-k-bJPp67CCpb0Q_gM88iWhT7AK_kpUtjQXcG/pubhtml?gid=2108884659&single=true"
          width="300%"
