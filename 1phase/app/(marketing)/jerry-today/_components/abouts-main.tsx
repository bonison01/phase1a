    ...
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="flex justify-center space-x-4 mb-4">
        ...
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/jerry-today">
            <a>Today Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/jerry-total">
            <a>Total Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/jerry-pending">
            <a>Pending Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/jerry-3day">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSpGVksaIwGI5j-PMP5C31htuqhwRjWe2QZcpBF5CIzqV85sAn30uGpSwn0jd5Vb7GswgFbAiW3nGDz/pubhtml?gid=1385903661&single=true"
          width="300%"
