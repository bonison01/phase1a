  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTHjcl3Q94IXXeDbNaWtiATlRCCY3-x78WrRpFBLqoRjJ5sBLZmebfWaNr-SNHV6eg2-92F_qKpjmH3/pubhtml?gid=2108884659&single=true"
          width="300%"
