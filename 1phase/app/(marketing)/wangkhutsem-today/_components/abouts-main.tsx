  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vRNXR6CpJyZATh3c-q_satrnNq9pOnGM_BQxGauXhNiuxkEQaqA3nnVv4IhaZlK16Z_tnauz5gXLoS9/pubhtml?gid=1385903661&single=true"
          width="300%"
