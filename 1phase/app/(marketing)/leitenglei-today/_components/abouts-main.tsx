    ...
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="flex justify-center space-x-4 mb-4">
        ...
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/leitenglei-today">
            <a>Today Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/leitenglei-total">
            <a>Total Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/leitenglei-pending">
            <a>Pending Orders</a>
          </Link>
        </button>
        <button className="bg-blue-500 hover:bg-blue-400 text-white font-bold py-1 px-2 rounded">
          <Link href="/leitenglei-3day">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQmWngxZ7KTO8ERih_UkVFqAg6BbzPy57kpD7HNn0LVcCZGdbpCNeYCsjbANQKdhU_t_dPpXIilr8kD/pubhtml?gid=1385903661&single=true"
          width="300%"
