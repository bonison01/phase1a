  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vTTW4yuTXxDNGtSZMWYVNEj93NmdTz_Zu97E7ibBFcb8LIJSSJVGuaHGvFgtdMmRlkkxjN-WSRUK4PD/pubhtml?gid=806582458&single=true"
          width="300%"
