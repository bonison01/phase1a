  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vR_7LL2vXro0opsi6obLMUr4jNth1KFsKRDi1l3a7yPyGz41H1h_JMetops9l1eu3wpVJ25LkQYscx5/pubhtml?gid=986061458&single=true"
          width="300%"
