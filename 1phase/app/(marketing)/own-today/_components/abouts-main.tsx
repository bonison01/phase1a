  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSL7aaquAHvMzYQ2NPHfMzrfEE_16wulaiLdnhcq-9WZnmL_GeNWHFxcOj_gnxPHifO9H2cvSIUPTRO/pubhtml?gid=1385903661&single=true"
          width="300%"
