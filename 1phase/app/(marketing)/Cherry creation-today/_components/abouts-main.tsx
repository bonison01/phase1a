  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vSnQFn-lfeYDXusJz7ZH2OnJnCgCGcSUDx_sACuoefBDpLLVoyuR0S-vp-L6Y1U3sHx2bd-OVU6jcSJ/pubhtml?gid=691031807&single=true"
          width="300%"
