  ...
  return (
    <div className="text-center pt-20 pb-10 sm:pt-32">
      ...
      <div className="w-full max-w-screen-lg mx-auto">
        <iframe
          src="https://docs.google.com/spreadsheets/d/e/2PACX-1vQwIALPXJr-AfIKK-eA-DtJ6vCBfWAHwi4AUgVcH8110EAWhp-NADQhs8-HwIks2zf7GenfOV-CDOf5/pubhtml?gid=2108884659&single=true"
          width="300%"
